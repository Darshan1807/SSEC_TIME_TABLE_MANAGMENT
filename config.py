...
class Config:
    ...
    MONGO_URI = os.environ.get('MONGO_URI', 'mongodb+srv://admin:SSECIT2026@cluster0.yh7oncz.mongodb.net/?appName=Cluster0')
    MONGO_DBNAME = os.environ.get('MONGO_DB_NAME', 'ssec_timetable_db')
