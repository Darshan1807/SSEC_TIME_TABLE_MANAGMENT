      ...
      <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-xl shadow-2xl overflow-hidden space-y-6 p-6 sm:p-8">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-4">
          ...
          <div className="flex justify-between items-center pt-2">
            <span className="text-[11px] text-slate-500 font-medium">Configured in <code className="text-sky-700 font-mono font-semibold">.env</code> & <code className="text-sky-700 font-mono font-semibold">config.py</code></span>
            <button
              onClick={handleSave}
